...
function init_focal_points() {
	for (let i = 0; i < MODELS.length; i++) {
		...
		if (m.focusable) {
			FOCAL_POINTS.push({
				name: m.name,
				angle: new THREE.Vector3(...m.view_position),
			});
		}
	}
