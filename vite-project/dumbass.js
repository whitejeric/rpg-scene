...
//TODO create init function
  ...
  const FIRST_POSITION = [-205,8000-2];
  ...
  console.log(camera_movement)
  const camera_dolly = new dolly(camera_movement);
  console.log('camera_dolly:');
  console.log(camera_dolly);
...
const FOCAL_DOLLY = []
console.log('here asdas'+FOCAL_POINTS)
for (let i = 0; i < FOCAL_POINTS.length; i++){
  FOCAL_DOLLY.push(FOCAL_POINTS[i].angle)
  // FOCAL_DOLLY.push(FIRST_POSITION)
}

console.log(FOCAL_DOLLY[0][0] + 'asdassssssffffffffffffsasadssssssssssssssd')
const focal_dolly = new dolly(FOCAL_DOLLY)

console.log('focal_points:');
console.log(FOCAL_POINTS)

console.log('focal_dolly:');
console.log(focal_dolly);
...
function focusCamera(t){
  let focusFinder = focal_dolly.move_camera(t)
  camera.lookAt(focusFinder[0]);
  console.log(focusFinder,t)
}
